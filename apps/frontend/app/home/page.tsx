          ...
          >
            ...
            <Card className="border border-gray-200 shadow-sm">
              ...
              <CardContent>
                ...
                <CardDescription>2 active candidates</CardDescription>
              </CardContent>
            </Card>
              ...
              <Card className="h-full border border-gray-200 hover:border-teal-500 hover:shadow-xl transition-all duration-300 bg-white">
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between">
                      <span className="text-gray-600">Last Score</span>
                      <span className="font-medium text-teal-600">91%</span>
                    </div>
                    <Button className="w-full mt-4" variant="outline">
                      Continue Practice <ArrowRight className="ml-2 h-4 w-4" />
                    </Button>
      ...
      <section className="py-16 bg-gradient-to-r from-teal-600 via-purple-700 to-teal-600 text-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Button
              size="lg"
              className="h-auto py-6 bg-white/10 hover:bg-white/20 backdrop-blur-sm border-white/20"
            >
